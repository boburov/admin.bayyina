...
const UsersStats = () => {
  ...
  return (
    <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 mb-4">
      {items.map((item) => {
        const c = colorMap[item.color];
        return (
          <Card key={item.label} className="flex items-center gap-3 !py-3">
            <div
              className={`flex items-center justify-center size-9 border shrink-0 ${c}`}
            >
